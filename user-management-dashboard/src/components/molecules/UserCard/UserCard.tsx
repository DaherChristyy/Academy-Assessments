...
export const UserCard: React.FC<UserCardProps> = ({
  ...
  return (
    <div
      className={`user-card ${className} flex flex-col p-4 rounded-lg shadow-lg bg-white dark:bg-gray-800 h-full min-h-[250px]`}
    >
      ...
      <div className="mt-4 flex justify-end gap-2 mt-auto">
        <Button variant="primary" className="dark:bg-primary-dark dark:text-white">Edit</Button>
        <Button variant="danger" className="dark:bg-red-600 dark:text-white">Delete</Button>
      </div>
    </div>
  );
};
